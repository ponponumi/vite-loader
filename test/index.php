...
<body>
  ...
  <p><?= $vite->typeGetPath("asset/ts/test.coffee") ?></p>
  <p><?= $vite->typeGetPath("asset/ts/test.ts") ?></p>
  <p><?= $vite->typeGetPath("asset/ts/test.sass") ?></p>
  <p><?= $vite->typeGetPath("asset/ts/test.scss") ?></p>
</body>
</html>
